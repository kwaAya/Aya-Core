...
export default function Footer() {
  return (
    <footer className="relative mt-14 overflow-hidden border-t border-white/10 bg-[radial-gradient(circle_at_top,_rgba(248,18,149,0.14),_transparent_30%),_linear-gradient(180deg,_rgba(17,17,19,1),_rgba(11,11,13,1))] px-6 py-10 text-white/65 md:px-10">
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-hotpink/80 to-transparent" />
      <div className="absolute -left-16 top-10 h-44 w-44 rounded-full bg-hotpink/12 blur-3xl" />
      <div className="absolute -right-10 bottom-2 h-36 w-36 rounded-full bg-[#8b5cf6]/10 blur-3xl" />
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-display text-2xl leading-tight text-white md:text-[2rem]">Aya Core Studios</p>
        ...
        <div className="flex flex-col gap-4 md:items-center">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-white/45">Explore</p>
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 font-heading text-sm text-white/75">
      ...
      <div className="relative mx-auto mt-9 flex max-w-6xl flex-col gap-3 border-t border-white/10 pt-5 text-[10px] font-mono uppercase tracking-[0.22em] text-white/45 md:flex-row md:items-center md:justify-between">
