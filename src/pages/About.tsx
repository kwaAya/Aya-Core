          ...
          >
            <div className="mx-auto md:mx-0 w-fit">
              <div className="relative h-40 w-40">
                ...
                <div
                  aria-hidden="true"
                  className="absolute -inset-3 rounded-full border border-hotpink/25 pointer-events-none"
                ...
                <div className="h-40 w-40 rounded-full overflow-hidden border-2 border-hotpink shadow-2xl">
              ...
              <p className="mt-3 text-center text-xs font-mono text-gray-400 whitespace-nowrap">
